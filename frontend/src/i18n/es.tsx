const es = {
  ...
  entities: {
    persons: {
        ...
        label: 'Persons',
        menu: 'Persons',
        exporterFileName: 'exportacion_persons',
        list: {
          menu: 'Persons',
          title: 'Persons',
        },
        create: {
          success: 'Persons guardado con éxito',
        },
        update: {
          success: 'Persons guardado con éxito',
        },
        destroy: {
          success: 'Persons eliminado con éxito',
        },
        destroyAll: {
          success: 'Persons(s) eliminado con éxito',
        },
        edit: {
        ...
        importer: {
          ...
          fileName: 'persons_import_template',
          hint:
    ...
    products: {
        ...
        label: 'Products',
        menu: 'Products',
        exporterFileName: 'exportacion_products',
        list: {
          menu: 'Products',
          title: 'Products',
        },
        create: {
          success: 'Products guardado con éxito',
        },
        update: {
          success: 'Products guardado con éxito',
        },
        destroy: {
          success: 'Products eliminado con éxito',
        },
        destroyAll: {
          success: 'Products(s) eliminado con éxito',
        },
        edit: {
    ...
    categories: {
        ...
        label: 'Categories',
        menu: 'Categories',
        exporterFileName: 'exportacion_categories',
        list: {
          menu: 'Categories',
          title: 'Categories',
        },
        create: {
          success: 'Categories guardado con éxito',
        },
        update: {
          success: 'Categories guardado con éxito',
        },
        destroy: {
          success: 'Categories eliminado con éxito',
        },
        destroyAll: {
          success: 'Categories(s) eliminado con éxito',
        },
        edit: {
          title: 'Editar Categories',
        },
        fields: {
          id: 'Id',
          'code': 'Code',
        ...
        new: {
          title: 'Nuevo Categories',
        },
        view: {
          title: 'Ver Categories',
        },
        importer: {
