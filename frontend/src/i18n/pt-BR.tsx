const ptBR = {
  ...
  entities: {
    ...
    products: {
        ...
        label: 'Products',
        menu: 'Products',
        exporterFileName: 'Products_exportados',
        list: {
          menu: 'Products',
          title: 'Products',
        },
        create: {
          success: 'Products salvo com sucesso',
        },
        update: {
          success: 'Products salvo com sucesso',
        },
        destroy: {
          success: 'Products deletado com sucesso',
        },
        destroyAll: {
          success: 'Products(s) deletado com sucesso',
        },
        edit: {
    ...
    categories: {
        ...
        label: 'Categories',
        menu: 'Categories',
        exporterFileName: 'Categories_exportados',
        list: {
          menu: 'Categories',
          title: 'Categories',
        },
        create: {
          success: 'Categories salvo com sucesso',
        },
        update: {
          success: 'Categories salvo com sucesso',
        },
        ...
        destroyAll: {
          success: 'Categories(s) deletado com sucesso',
        },
        edit: {
        ...
        new: {
          title: 'Novo Categories',
        },
        view: {
          title: 'Visualizar Categories',
        },
        importer: {
