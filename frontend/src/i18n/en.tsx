const en = {
  ...
  entities: {
    persons: {
        ...
        label: 'Persons',
        menu: 'Persons',
        exporterFileName: 'persons_export',
        list: {
          menu: 'Persons',
          title: 'Persons',
        },
        create: {
          success: 'Persons successfully saved',
        },
        update: {
          success: 'Persons successfully saved',
        },
        destroy: {
          success: 'Persons successfully deleted',
        },
        destroyAll: {
          success: 'Persons(s) successfully deleted',
        },
        edit: {
          title: 'Edit Persons',
        },
    ...
    products: {
        ...
        destroy: {
          success: 'Products successfully deleted',
        },
        destroyAll: {
          success: 'Products(s) successfully deleted',
        },
        edit: {
          title: 'Edit Products',
        },
    ...
    categories: {
        ...
        destroyAll: {
          success: 'Categories(s) successfully deleted',
        },
        edit: {
