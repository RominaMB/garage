...
import actions from 'src/modules/categories/list/categoriesListActions';
...
const CategoriesToolbar = (props) => {
  ...
  const hasPermissionToCreate = useSelector(
    categoriesSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    categoriesSelectors.selectPermissionToImport,
  );
  ...
  return (
    <Toolbar>
      ...
      {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=categories">
